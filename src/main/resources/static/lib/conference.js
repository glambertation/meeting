var conference = function(config) {
    ...
    function onDefaultSocketResponse(response) { 
        console.log("onDefaultSocketResponse响应了");
        if (response.text){
            config.receiveMessage(response);
    ...
    function startBroadcasting() {
        /*console.log('执行了一次startBroadcasting');*/
    ...
    return {
        createRoom: function(_config) {
            ...
            self.roomName = _config.roomName || 'admin';
        ...
        sendTxt: function(_config) {
            defaultSocket && defaultSocket.send({
                sender: _config.sender,
                text: _config.text
            });
            console.log("执行了一次sendTxt");
        },
        leaveRoom: leave
    };
};
